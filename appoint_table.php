...
<nav class="navbar navbar-expand-lg bg-info" id="navbar">
    ...
    <hr>
    <table class="table" style="margin-top: 80px; margin-left: 50px; width: 90%; text-align: center;">
        <thead>
          <tr>
...
$sql = "SELECT * FROM `DoctorAppointment`"; 
...
if ($res) { 
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        echo "<a href='delete_appointment.php?id=" . $row['Mr_Number'] . "' class='link-danger'><i class='fa-solid fa-trash' fs-5></i></a>";
        echo "</td>";
